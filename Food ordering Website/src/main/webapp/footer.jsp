...
<div class="_2tnu-">
		<div class="_2RZDN">
			<div class="_2Zn3W">
				<div class="_1Vw_y">
					<img class="_2dYjq" width="105" height="199"
				...
				<div class="_12i5X">Order in for yourself or for the group,
					with no restrictions on order value</div>
			</div>
			<div class="_2Zn3W">
				<div class="_1Vw_y">
					<img class="_2dYjq" width="112" height="206"
				...
				<div class="_12i5X">Know where your order is at all times,
					from the restaurant to your doorstep</div>
			</div>
			<div class="_2Zn3W">
				<div class="_1Vw_y">
					<img class="_2dYjq" width="124" height="188"
				...
				<div class="_12i5X">Experience Swiggy's superfast delivery for
					food delivered fresh &amp; on time</div>
			</div>
		</div>
	</div>
